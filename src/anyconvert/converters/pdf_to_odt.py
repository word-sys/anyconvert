"""
Native PDF to OpenDocument Text (.odt) converter.
Generates compliant OASIS OpenDocument packages without third-party converters.
"""
...
class PdfToOdtConverter(BaseConverter):
    """Converts PDF documents to native OASIS OpenDocument Text (.odt) files."""
    ...
    def convert_file(
        ...
        synthesizer = OdtSynthesizer(ir_doc, opts)
